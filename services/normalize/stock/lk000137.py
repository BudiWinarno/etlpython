...
class LK000137StockNormalizer(BaseNormalizer):
    ...
    def find_header_row(self, df):
        ...
        raise Exception("Header stock S126 tidak ditemukan")
    ...
    def normalize(self, filepath):
        ...
        # =====================================
        # Hapus baris kode barang kosong
        # =====================================
        df = df[
